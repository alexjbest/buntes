...
\hypertarget{p-246}{}%
This is in fact equivalent to the \hyperref[def-princ-pol]{previous definition~\ref{def-princ-pol}}, see \hyperlink{bib-vandergeer-moonen}{[65,~cor. 11.5]}.%
\end{remark}
\hypertarget{p-247}{}%
...
\hypertarget{p-262}{}%
See \hyperlink{bib-milne-etale}{[48]} or \hyperlink{bib-tamme}{[62]}.%
\par
\hypertarget{p-263}{}%
...
\end{definition}
\hypertarget{p-283}{}%
So we need to understand \hyperref[def-etale]{étale} covers of \hyperref[def-buntes-abvar]{abelian varieties}. Following \hyperlink{bib-vandergeer-moonen}{[65]}:%
...
\par
\hypertarget{p-785}{}%
References: [\hyperlink{bib-sutherland}{61}, \hyperlink{bib-voight-quat}{67}, \hyperlink{bib-velu}{66}]%
\end{introduction}%
%
%
\typeout{************************************************}
...
\par
\hypertarget{p-871}{}%
Lets compute an isogenous curve and see what happens! We will compute \(\psi\colon  E \to E/\langle P \rangle = E'\). In general the formulae are  a little annoying \hyperlink{bib-velu}{[66]}, when you have a 2-torsion point at \((0,0)\), not as bad:%
\begin{equation*}
...
\begin{introduction}{}%
\hypertarget{p-882}{}%
Pretty much all of this material was ripped with the utmost love and affection from \hyperlink{bib-voight-quat}{[67]}, check it out.%
...
\begin{theorem}{Main Theorem [67,~14.1.3].}{}{theorem-66}%
\hypertarget{p-930}{}%
...
\end{equation*}
which is now compact, \hyperref[sec-deuring]{genus} 0, which matches up with \(Y(1)\) having \(\CC\) points \(\CC\) earlier.%
\par
\hypertarget{p-1033}{}%
...
\begin{enumerate}
\item\hypertarget{li-260}{}Smooth proj. curve \hyperref[sec-deuring]{genus} 1 with a rational point.%
...
\end{equation*}
so \(\Delta(\tau)\) vanishes at \(\infty\) becasue \(g_2(\tau)\) doesn't  and \(j(z)\) has a  \hyperref[def-simple-av]{simple} pole at \(\infty\).%
\end{example}
\hypertarget{p-1066}{}%
...
\end{cases}
\end{equation*}
where \(g\) is the \hyperref[sec-deuring]{genus} of \(X(\Gamma)\) \(v_\infty\) is the number of inequivalent cusps \(P\) are the elliptic points \(\lb \cdot \rb\) is the integer part%
\begin{equation*}
\dim(S_k(\Gamma)) =
\begin{cases}
0 \amp \text{ if } k \le 0 \\
...
\end{equation*}
studying degree \(n\) \hyperref[def-supersing-isog-isog]{isogenies}, is like strudying index  \(n \) sublattices%
...
\end{corollary}
\hypertarget{p-1079}{}%
The \hyperref[def-buntes-cusp-forms]{Hecke operators} act on \hyperref[def-buntes-mfs]{modular forms} \(f(\tau)\) by reinterpreting weakly modualr functiosn of weight \(k\) as functions on \hyperref[def-buntes-lattice]{lattices} that have  a weight \(k\) action under homothety.%
\par
\hypertarget{p-1080}{}%
This boils down to%
\begin{equation*}
...
\par
\hypertarget{p-1086}{}%
Petersson inner product, is hermitian.%
\end{sectionptx}
\end{chapterptx}
%
\backmatter
...
\bibitem[61]{bib-sutherland}\hypertarget{bib-sutherland}{}Sutherland, Andrew. \textit{Isogeny volcanoes}. The Open Book Series 1, no. 1 (2013): 507-530. \url{https://msp.org/obs/2013/1-1/obs-v1-n1-p25-s.pdf}.
\bibitem[62]{bib-tamme}\hypertarget{bib-tamme}{}Tamme, Günter. \textit{Introduction to étale cohomology}. Springer Science \& Business Media, 2012.
\bibitem[63]{bib-tuitman-map-to-p1-1}\hypertarget{bib-tuitman-map-to-p1-1}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\)}. Mathematics of Computation 85.298 (2016): 961-981.
\bibitem[64]{bib-tuitman-map-to-p1-2}\hypertarget{bib-tuitman-map-to-p1-2}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\), II}. Finite Fields and Their Applications 45 (2017): 301-322.
\bibitem[65]{bib-vandergeer-moonen}\hypertarget{bib-vandergeer-moonen}{}van der Geer, G., Moonen, B. \textit{Abelian Varieties}, from \url{https://www.math.ru.nl/\~bmoonen/research.html\#bookabvar}.
\bibitem[66]{bib-velu}\hypertarget{bib-velu}{}Vélu, Jacques. \textit{Isogénies entre courbes elliptiques}. CR Acad. Sci. Paris, Séries A 273 (1971): 305-347.
\bibitem[67]{bib-voight-quat}\hypertarget{bib-voight-quat}{}Voight, John. \textit{Quaternion Algebras}. \url{http://quatalg.org}
\bibitem[68]{bib-waterhouse}\hypertarget{bib-waterhouse}{}Waterhouse, William C.  \textit{Profinite groups are Galois groups}. Proceedings of the American Mathematical Society 42.2 (1974): 639-640.
\bibitem[69]{bib-weng-nakamura}\hypertarget{bib-weng-nakamura}{}Weng, L., and Nakamura, I. \textit{Arithmetic geometry and number theory}, World Scientific, 2006.
\bibitem[70]{bib-zag-ram}\hypertarget{bib-zag-ram}{}Zagier, Don.  \textit{The Bloch-Wigner-Ramakrishnan polylogarithm function.} Mathematische Annalen 286, no. 1 (1990): 613-624.
\bibitem[71]{bib-pug}\hypertarget{bib-pug}{}\textit{Pug Template Engine} see \href{http://pug-lang.com/}{pug-lang.com}.
\end{thebibliography}
