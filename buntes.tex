...
\hypertarget{p-246}{}%
This is in fact equivalent to the \hyperref[def-princ-pol]{previous definition~\ref{def-princ-pol}}, see \hyperlink{bib-vandergeer-moonen}{[60,~cor. 11.5]}.%
\end{remark}
\hypertarget{p-247}{}%
...
\hypertarget{p-262}{}%
See \hyperlink{bib-milne-etale}{[43]} or \hyperlink{bib-tamme}{[57]}.%
\par
\hypertarget{p-263}{}%
...
\end{definition}
\hypertarget{p-283}{}%
So we need to understand \hyperref[def-etale]{étale} covers of \hyperref[def-buntes-abvar]{abelian varieties}. Following \hyperlink{bib-vandergeer-moonen}{[60]}:%
...
\end{theorem}
\hypertarget{p-298}{}%
Note that Milne gives a combined proof of the above two statements, this relies on some theorems on Hopf algebras such as \hyperlink{bib-borel-hopf}{[15,~Theoreme 6.1]}.%
%
%
\typeout{************************************************}
...
\hypertarget{p-423}{}%
The \terminology{Brauer group} of \(k\) \(\operatorname{Br}(k)\) is the set of \hyperref[def-csa]{central \hyperref[def-simple-av]{simple} algebras} under \(\otimes\) modulo the algebras \(M_n(k)\).%
\end{definition}
\begin{fact}{}{}{fact-4}%
\hypertarget{p-424}{}%
\leavevmode%
...
\par
\hypertarget{p-785}{}%
References: [\hyperlink{bib-sutherland}{56}, \hyperlink{bib-voight-quat}{62}, \hyperlink{bib-velu}{61}]%
%
%
\typeout{************************************************}
...
\hypertarget{p-808}{}%
A connected \(d\)-regular graph is a \terminology{Ramanujan graph} if \(\lambda_2 \le \sqrt{d-1}\) where \(\lambda_2\) is the second largest eigenvalue of its adjaceny matrix. (The largest one is always \(d\), by \(d\)-regularity.)%
\end{definition}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\section[{Quaternion Algebras (Alex)}]{Quaternion Algebras (Alex)}\label{sec-quaternion-algebras}
\hypertarget{p-865}{}%
...
\par
\hypertarget{p-871}{}%
Lets compute an isogenous curve and see what happens! We will compute \(\psi\colon  E \to E/\langle P \rangle = E'\). In general the formulae are  a little annoying \hyperlink{bib-velu}{[61]}, when you have a 2-torsion point at \((0,0)\), not as bad:%
\begin{equation*}
...
\begin{equation*}
E'\colon y^2 = x^3 + 0x^2 + (\alpha - 5\alpha)x +0 = x^3  - \alpha x
\end{equation*}
...
\typeout{************************************************}
%
\subsection[{Quaternion Algebras}]{Quaternion Algebras}\label{subsection-74}
\hypertarget{p-882}{}%
Pretty much all of this material was ripped with the utmost love and affection from \hyperlink{bib-voight-quat}{[62]}, check it out.%
...
\typeout{************************************************}
%
\subsubsection[{Orders}]{Orders}\label{subsubsection-1}
\hypertarget{p-903}{}%
...
\typeout{************************************************}
%
\subsubsection[{Local theory}]{Local theory}\label{subsubsection-2}
...
\hypertarget{p-922}{}%
Let \(B/F\) be a quaternion algebra  over  a  number field \(F\) (or any \hyperref[def-csa]{central \hyperref[def-simple-av]{simple} algebra}), if \(B\) splits at every place \(v\) of \(F\) then \(B\) is a matrix algebra \(M_d (F)\).%
\end{theorem}
\hypertarget{p-923}{}%
In fact:%
...
\begin{theorem}{Main Theorem [62,~14.1.3].}{}{theorem-66}%
\hypertarget{p-927}{}%
...
\bibitem[50]{bib-serre-course}\hypertarget{bib-serre-course}{}Serre, Jean-Pierre. \textit{A course in arithmetic}. Vol. 7. Springer Science \& Business Media, 2012.
\bibitem[51]{bib-serre-local-alg}\hypertarget{bib-serre-local-alg}{}Serre, Jean-Pierre. \textit{Local algebra}. Springer Science \& Business Media, 2000.
\bibitem[52]{bib-serre-mordell-weil}\hypertarget{bib-serre-mordell-weil}{}Serre, Jean-Pierre, Martin Brown, and Michel Waldschmidt. \textit{Lectures on the Mordell-Weil theorem}. Vol. 2. Braunschweig: Vieweg, 1990.
\bibitem[53]{bib-shafarevich-remizov}\hypertarget{bib-shafarevich-remizov}{}Shafarevich, Igor R., and Alexey O. Remizov. \textit{Linear algebra and geometry}. Springer Science \& Business Media, 2012.
\bibitem[54]{bib-silverman}\hypertarget{bib-silverman}{}Silverman, Joseph H. \textit{The arithmetic of elliptic curves}. Vol. 106. Springer Science \& Business Media, 2009.
\bibitem[55]{bib-silverman-advanced}\hypertarget{bib-silverman-advanced}{}Silverman, Joseph H. \textit{Advanced topics in the arithmetic of elliptic curves}. Vol. 151. Springer Science \& Business Media, 2013.
\bibitem[56]{bib-sutherland}\hypertarget{bib-sutherland}{}Sutherland, Andrew. \textit{Isogeny volcanoes}. The Open Book Series 1, no. 1 (2013): 507-530. \url{https://msp.org/obs/2013/1-1/obs-v1-n1-p25-s.pdf}.
\bibitem[57]{bib-tamme}\hypertarget{bib-tamme}{}Tamme, Günter. \textit{Introduction to étale cohomology}. Springer Science \& Business Media, 2012.
\bibitem[58]{bib-tuitman-map-to-p1-1}\hypertarget{bib-tuitman-map-to-p1-1}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\)}. Mathematics of Computation 85.298 (2016): 961-981.
\bibitem[59]{bib-tuitman-map-to-p1-2}\hypertarget{bib-tuitman-map-to-p1-2}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\), II}. Finite Fields and Their Applications 45 (2017): 301-322.
\bibitem[60]{bib-vandergeer-moonen}\hypertarget{bib-vandergeer-moonen}{}van der Geer, G., Moonen, B. \textit{Abelian Varieties}, from \url{https://www.math.ru.nl/\~bmoonen/research.html\#bookabvar}.
\bibitem[61]{bib-velu}\hypertarget{bib-velu}{}Vélu, Jacques. \textit{Isogénies entre courbes elliptiques}. CR Acad. Sci. Paris, Séries A 273 (1971): 305-347.
\bibitem[62]{bib-voight-quat}\hypertarget{bib-voight-quat}{}Voight, John. \textit{Quaternion Algebras}. \url{http://quatalg.org}
\bibitem[63]{bib-waterhouse}\hypertarget{bib-waterhouse}{}Waterhouse, William C.  \textit{Profinite groups are Galois groups}. Proceedings of the American Mathematical Society 42.2 (1974): 639-640.
\bibitem[64]{bib-weng-nakamura}\hypertarget{bib-weng-nakamura}{}Weng, L., and Nakamura, I. \textit{Arithmetic geometry and number theory}, World Scientific, 2006.
\bibitem[65]{bib-zag-ram}\hypertarget{bib-zag-ram}{}Zagier, Don.  \textit{The Bloch-Wigner-Ramakrishnan polylogarithm function.} Mathematische Annalen 286, no. 1 (1990): 613-624.
\bibitem[66]{bib-pug}\hypertarget{bib-pug}{}\textit{Pug Template Engine} see \href{http://pug-lang.com/}{pug-lang.com}.
\end{thebibliography}
\end{document}