...
\end{equation*}
Also a \hyperref[def-polarization]{polarization} \(\lambda \colon A \to A^\vee\) is equivalent to choosing a \hyperref[def-riemann-form]{Riemann form}%
\begin{equation*}
...
\item\hypertarget{li-284}{}To what extent can we read off the geometric data of \(X\) from its \hyperref[def-hodge-str]{Hodge structure}.%
\end{enumerate}
%
\end{subsectionptx}
%
...
\hypertarget{p-1201}{}%
Let \(G\) be a real \hyperref[def-alg-gp]{algebraic group} with involution \(\sigma\). The \terminology{real form} associated to \(\sigma\) is%
\begin{equation*}
...
\hypertarget{p-1204}{}%
Let \(G\) be connected, then \(G\) is reductive iff \(G\) admits a \hyperref[sec-buntes-ricky2]{Cartan involution}.%
\end{theorem}
\begin{lemma}{for next time.}{}{lemma-25}%
\hypertarget{p-1205}{}%
If \(K\) is a compact lie group then any \(\CC\)-representation \(V\) of it admits a \(K\)-invariant pos. def. \hyperref[sec-buntes-av-jac]{Hermitian form}%
\par
\hypertarget{p-1206}{}%
