...
%
\typeout{************************************************}
\typeout{Section 4.1 \(p\)-divisible groups}
\typeout{************************************************}
%
\begin{sectionptx}{\(p\)-divisible groups}{}{\(p\)-divisible groups}{}{}\label{sec-p-div-gps}
\hypertarget{p-986}{}%
...
f_1=  f_2 = \cdots = f_m = 0
\end{equation*}
with coefficients in \(lk\) this is asking for  a map%
\begin{equation*}
