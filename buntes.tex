...
%
\typeout{************************************************}
\typeout{Subsection 1.7.1 Aside: alternate description of \(\Pic^0(A)\)}
\typeout{************************************************}
%
\subsection[{Aside: alternate description of \(\Pic^0(A)\)}]{Aside: alternate description of \(\Pic^0(A)\)}\label{subsection-19}
...
%
\typeout{************************************************}
\typeout{Subsection 1.7.2 See-Saws}
\typeout{************************************************}
%
\subsection[{See-Saws}]{See-Saws}\label{subsection-20}
...
%
\typeout{************************************************}
\typeout{Subsection 1.7.3 Properties of \(\Pic^0 A\)}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1.7.4 The Dual Abelian Variety}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 1.7.5 Dual morphisms}
\typeout{************************************************}
%
...
\typeout{************************************************}
%
\paragraph[{Fuchsian groups}]{Fuchsian groups}\hypertarget{paragraphs-10}{}
\hypertarget{p-550}{}%
\(g \ge 2\).%
\begin{equation*}
...
\typeout{************************************************}
%
\paragraph[{Reflections on \(\HH\)}]{Reflections on \(\HH\)}\hypertarget{paragraphs-11}{}
\hypertarget{p-553}{}%
...
\typeout{************************************************}
%
\subsection[{Galois coverings}]{Galois coverings}\label{subsection-51}
...
%
\typeout{************************************************}
\typeout{Subsection 2.7.1.1 Dessins 2 Belyi pairs}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Supersingular isogney graphs}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Ordinary isogney graphs}
\typeout{************************************************}
%
