...
\item\hypertarget{item-nonsing-pt}{}\(E\) is nonsingular of \hyperref[fact-existance-genus]{genus} 1 with a distinguished point \(P_0\).%
\item\hypertarget{item-nonsing-gp}{}\(E\) is nonsingular with an \hyperref[def-alg-gp]{algebraic group} structure.%
\item\hypertarget{item-cmplx}{}(if \(k \subseteq \CC\)) such that \(E(\CC) = \CC/\Lambda\) for some lattice \(\Lambda \subseteq \CC\).%
\end{enumerate}
%
\end{theorem}
...
\typeout{************************************************}
%
\subsection[{In which Owl proves the ampleness of \(L\) implies finiteness of \(K(L)\)}]{In which Owl proves the ampleness of \(L\) implies finiteness of \(K(L)\)}\label{sec-ample-L-finite-KL}
\hypertarget{p-146}{}%
...
\typeout{************************************************}
%
\subsection[{Introduction}]{Introduction}\label{subsection-19}
%
%
\typeout{************************************************}
\typeout{Paragraphs  Meta-goal}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Goals}
\typeout{************************************************}
%
\paragraph[{Goals}]{Goals}\hypertarget{paragraphs-5}{}
\hypertarget{p-171}{}%
...
\typeout{************************************************}
%
\subsection[{Aside: alternate description of \(\Pic^0(A)\)}]{Aside: alternate description of \(\Pic^0(A)\)}\label{subsection-20}
...
\typeout{************************************************}
%
\subsection[{See-Saws}]{See-Saws}\label{subsection-21}
...
\typeout{************************************************}
%
\subsection[{Properties of \(\Pic^0 A\)}]{Properties of \(\Pic^0 A\)}\label{subsection-22}
\begin{lemma}{}{}{lemma-2}%
\hypertarget{p-179}{}%
...
\typeout{************************************************}
%
\subsection[{The Dual Abelian Variety}]{The Dual Abelian Variety}\label{subsection-23}
...
\typeout{************************************************}
%
\subsection[{Dual morphisms}]{Dual morphisms}\label{subsection-24}
\hypertarget{p-195}{}%
...
\typeout{************************************************}
%
\subsection[{Poincaré's complete reducibility theorem}]{Poincaré's complete reducibility theorem}\label{subsection-25}
...
\typeout{************************************************}
%
\subsection[{Polarizations}]{Polarizations}\label{subsection-26}
...
\typeout{************************************************}
%
\subsection[{Étale Cohomology of Abelian Varieties}]{Étale Cohomology of Abelian Varieties}\label{subsection-27}
\hypertarget{p-262}{}%
...
\typeout{************************************************}
%
\subsection[{Weil pairings on elliptic curves}]{Weil pairings on elliptic curves}\label{subsection-28}
\hypertarget{p-299}{}%
...
\typeout{************************************************}
%
\subsection[{Weil pairings on abelian varieties}]{Weil pairings on abelian varieties}\label{subsection-29}
\hypertarget{p-300}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Notation}
\typeout{************************************************}
%
\paragraph[{Notation}]{Notation}\hypertarget{paragraphs-6}{}
\hypertarget{p-305}{}%
...
\typeout{************************************************}
%
\subsection[{Results about polarizations}]{Results about polarizations}\label{subsection-30}
\hypertarget{p-309}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Honda-Tate}
\typeout{************************************************}
%
\paragraph[{Honda-Tate}]{Honda-Tate}\hypertarget{paragraphs-7}{}
\hypertarget{p-371}{}%
...
\typeout{************************************************}
%
\subsection[{The Theorem}]{The Theorem}\label{subsection-31}
...
\typeout{************************************************}
%
\subsection[{Motivation}]{Motivation}\label{subsection-32}
\hypertarget{p-378}{}%
...
\typeout{************************************************}
%
\subsection[{Isogeny category}]{Isogeny category}\label{subsection-33}
\hypertarget{p-383}{}%
...
\typeout{************************************************}
%
\subsection[{Reductions}]{Reductions}\label{subsection-34}
\begin{lemma}{}{}{lemma-7}%
\hypertarget{p-385}{}%
\leavevmode%
\begin{enumerate}
...
\typeout{************************************************}
%
\subsection[{Proof of Tate using finiteness}]{Proof of Tate using finiteness}\label{subsection-35}
\hypertarget{p-391}{}%
...
\typeout{************************************************}
%
\subsection[{Honda-Tate map}]{Honda-Tate map}\label{subsection-36}
\hypertarget{p-409}{}%
Recall:%
...
\typeout{************************************************}
%
\subsection[{Injectivity and Brauer groups}]{Injectivity and Brauer groups}\label{subsection-37}
\hypertarget{p-416}{}%
From last time:%
...
\begin{definition}{Central simple algebras.}{def-csa}%
\hypertarget{p-421}{}%
...
\hypertarget{p-423}{}%
The \terminology{Brauer group} of \(k\) \(\operatorname{Br}(k)\) is the set of \hyperref[def-csa]{central \hyperref[def-simple-av]{simple} algebras} under \(\otimes\) module the algebras \(M_n(k)\).%
\end{definition}
\begin{fact}{}{}{fact-4}%
\hypertarget{p-424}{}%
\leavevmode%
...
\typeout{************************************************}
%
\subsection[{Surjectivity and CM theory}]{Surjectivity and CM theory}\label{subsection-38}
\hypertarget{p-431}{}%
...
\typeout{************************************************}
%
\subsection[{Belyi morphisms}]{Belyi morphisms}\label{subsection-39}
\hypertarget{p-457}{}%
...
\typeout{************************************************}
%
\subsection[{Dessin d'Enfants}]{Dessin d'Enfants}\label{subsection-40}
...
\typeout{************************************************}
%
\subsection[{The Grothendieck correspondence}]{The Grothendieck correspondence}\label{subsection-41}
\hypertarget{p-468}{}%
...
\typeout{************************************************}
%
\subsection[{Covering spaces and Galois groups}]{Covering spaces and Galois groups}\label{subsection-42}
\hypertarget{p-472}{}%
...
\typeout{************************************************}
%
\subsection[{Exercises}]{Exercises}\label{subsection-43}
...
\typeout{************************************************}
%
\subsection[{Definitions}]{Definitions}\label{subsection-44}
...
\typeout{************************************************}
%
\subsection[{Examples}]{Examples}\label{subsection-45}
...
\typeout{************************************************}
%
\subsection[{Morphisms}]{Morphisms}\label{subsection-46}
...
\typeout{************************************************}
%
\subsection[{Ramification}]{Ramification}\label{subsection-47}
...
\typeout{************************************************}
%
\subsection[{Genus}]{Genus}\label{subsection-48}
...
%
\typeout{************************************************}
\typeout{Paragraphs  A 3-fold equivalence of categories}
\typeout{************************************************}
%
\paragraph[{A 3-fold equivalence of categories}]{A 3-fold equivalence of categories}\hypertarget{paragraphs-8}{}
\hypertarget{p-523}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Riemann-Hurwitz (generally)}
\typeout{************************************************}
%
\paragraph[{Riemann-Hurwitz (generally)}]{Riemann-Hurwitz (generally)}\hypertarget{paragraphs-9}{}
\hypertarget{p-531}{}%
...
\typeout{************************************************}
%
\subsection[{Uniformization}]{Uniformization}\label{subsection-49}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Goal}
\typeout{************************************************}
%
\paragraph[{Goal}]{Goal}\hypertarget{paragraphs-10}{}
\hypertarget{p-549}{}%
Understand \(\Sigma \) through \(\widetilde \Sigma\) and \(G\).%
%
%
\typeout{************************************************}
\typeout{Paragraphs  Fuchsian groups}
\typeout{************************************************}
%
\paragraph[{Fuchsian groups}]{Fuchsian groups}\hypertarget{paragraphs-11}{}
\hypertarget{p-550}{}%
\(g \ge 2\).%
\begin{equation*}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Reflections on \(\HH\)}
\typeout{************************************************}
%
\paragraph[{Reflections on \(\HH\)}]{Reflections on \(\HH\)}\hypertarget{paragraphs-12}{}
\hypertarget{p-553}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Triangle groups}
\typeout{************************************************}
%
\paragraph[{Triangle groups}]{Triangle groups}\hypertarget{paragraphs-13}{}
\hypertarget{p-554}{}%
...
\typeout{************************************************}
%
\subsection[{Moduli space of compact Riemann surfaces with genus \(g\)}]{Moduli space of compact Riemann surfaces with genus \(g\)}\label{subsection-50}
\hypertarget{p-573}{}%
...
\typeout{************************************************}
%
\subsection[{Monodromy}]{Monodromy}\label{subsection-51}
\hypertarget{p-578}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Monodromy and Fuchsian groups}
\typeout{************************************************}
%
\paragraph[{Monodromy and Fuchsian groups}]{Monodromy and Fuchsian groups}\hypertarget{paragraphs-14}{}
\hypertarget{p-579}{}%
Let%
\begin{equation*}
...
\typeout{************************************************}
%
\subsection[{Galois coverings}]{Galois coverings}\label{subsection-52}
...
\typeout{************************************************}
%
\subsection[{Normalization of coverings of \(\PP^1\)}]{Normalization of coverings of \(\PP^1\)}\label{subsection-53}
\hypertarget{p-589}{}%
...
\typeout{************************************************}
%
\subsection[{Proof of a) implies b)}]{Proof of a) implies b)}\label{subsection-54}
\begin{note}{}{note-7}%
\hypertarget{p-603}{}%
...
\typeout{************************************************}
%
\subsection[{Algebraic characterization of morphisms}]{Algebraic characterization of morphisms}\label{subsection-55}
...
\typeout{************************************************}
%
\subsection[{Galois action}]{Galois action}\label{subsection-56}
\hypertarget{p-611}{}%
...
\typeout{************************************************}
%
\subsection[{Points and valuations}]{Points and valuations}\label{subsection-57}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Galois action on points}
\typeout{************************************************}
%
\paragraph[{Galois action on points}]{Galois action on points}\hypertarget{paragraphs-15}{}
...
\typeout{************************************************}
%
\subsection[{Elementary invariants of the action of \(\operatorname{Gal}(\CC)\).}]{Elementary invariants of the action of \(\operatorname{Gal}(\CC)\).}\label{subsection-58}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Proof of b implies a in Belyi's theorem (3.61)}
\typeout{************************************************}
%
\paragraph[{Proof of b implies a in Belyi's theorem (3.61)}]{Proof of b implies a in Belyi's theorem (3.61)}\hypertarget{paragraphs-16}{}
\hypertarget{p-633}{}%
...
\typeout{************************************************}
%
\subsection[{The field of definition of Belyi functions (3.8)}]{The field of definition of Belyi functions (3.8)}\label{subsection-59}
...
\typeout{************************************************}
%
\subsection[{Dessins}]{Dessins}\label{subsection-60}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Permutation representation of a Dessin}
\typeout{************************************************}
%
\paragraph[{Permutation representation of a Dessin}]{Permutation representation of a Dessin}\hypertarget{paragraphs-17}{}
\hypertarget{p-640}{}%
...
\typeout{************************************************}
%
\subsection[{Dessins 2 Belyi pairs}]{Dessins 2 Belyi pairs}\label{subsection-61}
\hypertarget{p-653}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Motivation: ABC implies Fermat bound}
\typeout{************************************************}
%
\paragraph[{Motivation: ABC implies Fermat bound}]{Motivation: ABC implies Fermat bound}\hypertarget{paragraphs-18}{}
\hypertarget{p-680}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  ABC implies a bound on Mordell}
\typeout{************************************************}
%
\paragraph[{ABC implies a bound on Mordell}]{ABC implies a bound on Mordell}\hypertarget{paragraphs-19}{}
\hypertarget{p-686}{}%
...
\typeout{************************************************}
%
\section[{Dessins, integer points on elliptic curves and a proof of the ABC conjecture (Alex)}]{Dessins, integer points on elliptic curves and a proof of the ABC conjecture (Alex)}\label{sec-dessins-integer-pts-abc}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\subsection[{A proof of the ABC theorem (for polynomials)}]{A proof of the ABC theorem (for polynomials)}\label{subsection-62}
\hypertarget{p-698}{}%
...
\typeout{************************************************}
%
\subsection[{Back to number theory}]{Back to number theory}\label{subsection-63}
\hypertarget{p-705}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  References}
\typeout{************************************************}
%
\paragraph[{References}]{References}\hypertarget{paragraphs-20}{}
\hypertarget{p-734}{}%
...
\typeout{************************************************}
%
\subsection[{The case of the Rising Degree}]{The case of the Rising Degree}\label{subsection-64}
...
\typeout{************************************************}
%
\subsection[{Finitists Dream}]{Finitists Dream}\label{subsection-65}
\hypertarget{p-748}{}%
...
\typeout{************************************************}
%
\subsection[{In the Stacks}]{In the Stacks}\label{subsection-66}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Physics}
\typeout{************************************************}
%
\paragraph[{Physics}]{Physics}\hypertarget{paragraphs-21}{}
\hypertarget{p-770}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Quivers and dessins}
\typeout{************************************************}
%
\paragraph[{Quivers and dessins}]{Quivers and dessins}\hypertarget{paragraphs-22}{}
\hypertarget{p-772}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  The modular equation}
\typeout{************************************************}
%
\paragraph[{The modular equation}]{The modular equation}\hypertarget{paragraphs-23}{}
\hypertarget{p-794}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  The endomorphism ring}
\typeout{************************************************}
%
\paragraph[{The endomorphism ring}]{The endomorphism ring}\hypertarget{paragraphs-24}{}
...
%
\typeout{************************************************}
\typeout{Paragraphs  Isogeny graphs of elliptic curves}
\typeout{************************************************}
%
\paragraph[{Isogeny graphs of elliptic curves}]{Isogeny graphs of elliptic curves}\hypertarget{paragraphs-25}{}
\hypertarget{p-800}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Supersingular isogeny graphs}
\typeout{************************************************}
%
\paragraph[{Supersingular isogeny graphs}]{Supersingular isogeny graphs}\hypertarget{paragraphs-26}{}
\hypertarget{p-803}{}%
...
\hypertarget{p-807}{}%
A \(d\)-regular graph is a \terminology{Ramanujan graph} if \(\lambda_2 \le \sqrt{d-1}\) where \(\lambda_2\) is the second largest eigenvalue of its adjaceny matrix. (The largest one is always \(d\), by \(d\)-regularity.)%
\end{definition}
%
%
\typeout{************************************************}
\typeout{Paragraphs  Ordinary isogeny graphs}
\typeout{************************************************}
%
\paragraph[{Ordinary isogeny graphs}]{Ordinary isogeny graphs}\hypertarget{paragraphs-27}{}
\hypertarget{p-808}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Horizontal isogenies}
\typeout{************************************************}
%
\paragraph[{Horizontal isogenies}]{Horizontal isogenies}\hypertarget{paragraphs-28}{}
\hypertarget{p-811}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Vertical isogenies}
\typeout{************************************************}
%
\paragraph[{Vertical isogenies}]{Vertical isogenies}\hypertarget{paragraphs-29}{}
\hypertarget{p-814}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Application: Identifying supersingular elliptic curves}
\typeout{************************************************}
%
\paragraph[{Application: Identifying supersingular elliptic curves}]{Application: Identifying supersingular elliptic curves}\hypertarget{paragraphs-30}{}
...
\typeout{************************************************}
%
\section[{Supersingular isogeny graph cryptography (Asra)}]{Supersingular isogeny graph cryptography (Asra)}\label{sec-supersing-isog-crypto}
\hypertarget{p-822}{}%
...
\hypertarget{p-824}{}%
If \(G\) is Ramanujan, \(x\in V, S\subseteq V\). For a sufficiently large path the probability that the path ends in \(S\) is at least \(|S|/2|G|\).%
\end{proposition}
\hypertarget{p-825}{}%
Upshot supersingular \hyperref[def-supersing-isog-isog]{isogeny} graphs are \((l +1)\)-regular, undirected, Ramanujan, connected.%
\par
\hypertarget{p-826}{}%
...
\typeout{************************************************}
%
\subsection[{Hash functions}]{Hash functions}\label{subsection-68}
\hypertarget{p-828}{}%
...
\typeout{************************************************}
%
\subsection[{Supersingular isogeny hash functions}]{Supersingular isogeny hash functions}\label{subsection-69}
%
%
\typeout{************************************************}
\typeout{Paragraphs  Parameters}
\typeout{************************************************}
%
\paragraph[{Parameters}]{Parameters}\hypertarget{paragraphs-31}{}
\hypertarget{p-833}{}%
\(G_l(\FF_{p^2})\), \(p \equiv 1 \pmod{12}\), \(l\) to be small, fix an ordering on the edges, fix an initial vertex \(j_0\) and an incoming edge.%
%
%
\typeout{************************************************}
\typeout{Paragraphs  Protocol}
\typeout{************************************************}
%
\paragraph[{Protocol}]{Protocol}\hypertarget{paragraphs-32}{}
\hypertarget{p-834}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Properties}
\typeout{************************************************}
%
\paragraph[{Properties}]{Properties}\hypertarget{paragraphs-33}{}
\hypertarget{p-836}{}%
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-211}{}Preimage resistant iff when given \(j\) it is difficult to compute a positive integer \(e\) and an \hyperref[def-supersing-isog-isog]{isogeny} \(\phi\colon E_{j_0} \to E_j\) with degree \(l^e\).%
\item\hypertarget{li-212}{}Collision resistant iff when given \(j\) it is difficult to compute \(e\) and  \(\phi \colon E_{j_0} \to E_{j_0}\) with degree \(l^e\).%
\end{enumerate}
%
\end{proposition}
%
...
\typeout{************************************************}
%
\subsection[{Diffie-Hellman Key Exchange (1976)}]{Diffie-Hellman Key Exchange (1976)}\label{subsection-70}
\hypertarget{p-838}{}%
...
\typeout{************************************************}
%
\subsection[{Supersingular isogeny Diffie-Hellman (SIDH)}]{Supersingular isogeny Diffie-Hellman (SIDH)}\label{subsection-71}
%
%
\typeout{************************************************}
\typeout{Paragraphs  Parameters}
...
\typeout{************************************************}
%
\paragraph[{Protocol}]{Protocol}\hypertarget{paragraphs-35}{}
\hypertarget{p-842}{}%
...
%
\typeout{************************************************}
\typeout{Paragraphs  Hardness}
\typeout{************************************************}
%
\paragraph[{Hardness}]{Hardness}\hypertarget{paragraphs-36}{}
\hypertarget{p-851}{}%
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-213}{}(Decisional supersingular \hyperref[def-supersing-isog-isog]{isogeny} problem) Given \(E, (P_A,Q_A)\) a basis for \(l_A^{e_A}\) torsion, let \(E_A\) be another curve, is \(E_A\) \(l_A^{e_A}\) isogenous to \(E\)?%
\item\hypertarget{li-214}{}(Computational supersingular \hyperref[def-supersing-isog-isog]{isogeny} problem) Let \(\phi_A \colon E \to E_A\) be an \hyperref[def-supersing-isog-isog]{isogeny} with a kernel of the form \(\langle m_AP_A + n_AQ_A \rangle\). Given \(E_A\) and \(\phi_A(P_B)\) \(\phi_A(Q_B)\), find \(R_A\). \(p^{1/4}\) classical, \(p^{1/6}\) quantum.%
\item\hypertarget{li-215}{}Given \(E_A, E_B, \phi_A(P_B), \phi_A(Q_B), \phi_B(P_A), \phi_B(Q_A)\) find \(j\)-invariant of \(E_{AB}\).%
\end{enumerate}
%
%
%
...
\typeout{************************************************}
%
\subsection[{Supersingular isogeny public key}]{Supersingular isogeny public key}\label{subsection-72}
\hypertarget{p-852}{}%
...
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-216}{}\hypertarget{p-854}{}%
Key generation.%
\par
\hypertarget{p-855}{}%
Alice: secret \(\phi_A \colon E \to E_A\), public \(E_A\) and \(\phi_A(P_B), \phi_A(Q_B)\).%
\item\hypertarget{li-217}{}\hypertarget{p-856}{}%
Encryption.%
\par
\hypertarget{p-857}{}%
...
\item\hypertarget{li-218}{}\hypertarget{p-859}{}%
Decryption.%
\par
\hypertarget{p-860}{}%
...
\typeout{************************************************}
%
\subsection[{Algorithmic aspects}]{Algorithmic aspects}\label{subsection-73}
\hypertarget{p-862}{}%
\leavevmode%
\begin{enumerate}
\item\hypertarget{li-219}{}(Choosing \(f\)) Prime number theorem for arithmetic progressions gives you a bound on the density of primes of the form \(l_A^{e_A} l_B^{e_B} f \pm 1\)%
\item\hypertarget{li-220}{}Choosing a s.s. e.c. with the right group order, Broker's algorithm.%
\item\hypertarget{li-221}{}\hypertarget{p-863}{}%
Finding a basis for \(E\lb l_A^{e_A}\rb\).%
\begin{enumerate}
\item\hypertarget{li-222}{}Find a random point in \(E(\FF_{p^2})\) say \(P\).%
\item\hypertarget{li-223}{}Check the order of \((l_B^{e_B} f)^2 \cdot P\). If its \(l_A^{e_A}\) set \(P_A = P\). Otherwise repeat from 1.%
\item\hypertarget{li-224}{}Do the same with \(Q_A = Q\).%
\item\hypertarget{li-225}{}Check independence by seeing if \(e(P_A,Q_A) \)%
\end{enumerate}
%
\item\hypertarget{li-226}{}Computing the kernels generated by \(R_A = m_A P_A + n_A Q_A\), \(m_A, n_A \in \ZZ/l_A^{e_A} \ZZ\). Analogue of double and add. Set \(R_A = P_A + \lb m_A\inv n_A\rb Q_A\). Use differential addition (when you compute \(A+B\) with side info \(A-B\)) and a Montgomery ladder%
\item\hypertarget{li-227}{}(Computing smooth degree \hyperref[def-supersing-isog-isog]{isogenies}) Decompose the \(l_A^{e_A}\) \hyperref[def-supersing-isog-isog]{isogeny} into \(e_A\) different \(l_A\)-\hyperref[def-supersing-isog-isog]{isogenies}, \(\phi_i\colon E_i \to E_{i+1}\) the kernel of \(\phi_i\) is \(\langle l_A^{e_A - i - 1} R_A\rangle\). Velu's formula runs in \(O(l)\) for \(l\)-\hyperref[def-supersing-isog-isog]{isogeny}.%
\end{enumerate}
%
%
\backmatter
...
\bibitem[13]{bib-bloch}\hypertarget{bib-bloch}{}Bloch, Spencer.  \textit{Higher regulators, algebraic K-theory, and zeta functions of elliptic curves.} Vol. 11. American Mathematical Soc., 2000.
\bibitem[14]{bib-bochner-formal}\hypertarget{bib-bochner-formal}{}Bochner, S. \textit{Formal Lie Groups}. Annals of Mathematics, vol. 47, no. 2, 1946, pp. 192–201. JSTOR, JSTOR, \url{www.jstor.org/stable/1969242}.
\bibitem[15]{bib-borel-hopf}\hypertarget{bib-borel-hopf}{}Borel, Armand. \textit{Sur La Cohomologie Des Espaces Fibres Principaux Et Des Espaces Homogenes De Groupes De Lie Compacts}. Annals of Mathematics, Second Series, 57, no. 1 (1953): 115-207. doi:10.2307/1969728.
\bibitem[16]{bib-bostan-gaudry-schost}\hypertarget{bib-bostan-gaudry-schost}{}Bostan, Alin, Gaudry, Pierrick, and Schost, Éric. \textit{Linear recurrences with polynomial coefficients and application to integer factorization and Cartier-Manin operator}. SIAM Journal on Computing 36, no. 6 (2007): 1777-1806.
\bibitem[17]{bib-chen}\hypertarget{bib-chen}{}Chen, Kuo-Tsai.  \textit{Algebras of iterated path integrals and fundamental groups.} Transactions of the American Mathematical Society 156 (1971): 359-379.
\bibitem[18]{bib-coleman-torsion}\hypertarget{bib-coleman-torsion}{}Coleman, Robert F.  \textit{Torsion points on curves and p-adic abelian integrals.} Annals of Mathematics 121.1 (1985): 111-168.
\bibitem[19]{bib-coleman-chabauty}\hypertarget{bib-coleman-chabauty}{}Coleman, Robert F.  \textit{Effective Chabauty} Duke Math. J 52.3 (1985): 765-770.
\bibitem[20]{bib-coleman-de-shalit}\hypertarget{bib-coleman-de-shalit}{}Coleman, Robert, and Ehud De Shalit. \textit{\(p\)-adic regulators on curves and special values of \(p\)-adic \(L\)-functions}. Inventiones mathematicae 93, no. 2 (1988): 239-266.
\bibitem[21]{bib-coleman-dilogs}\hypertarget{bib-coleman-dilogs}{}Coleman, Robert F. \textit{Dilogarithms, regulators and \(p\)-adic \(L\)-functions}. Inventiones mathematicae 69, no. 2 (1982): 171-208.
\bibitem[22]{bib-coleman-gross}\hypertarget{bib-coleman-gross}{}Coleman, Robert F., and B. Gross. \textit{p-adic Heights on Curves} Math. Sciences Research Inst., Berkeley, Calif. (1987).
\bibitem[23]{bib-fresnel-van-der-put}\hypertarget{bib-fresnel-van-der-put}{}Fresnel, Jean, and Marius Van der Put \textit{Rigid analytic geometry and its applications} Vol. 218. Springer Science \& Business Media, 2012.
\bibitem[24]{bib-gabber-ramero}\hypertarget{bib-gabber-ramero}{}Gabber O, Ramero L. \textit{Almost ring theory}. Springer; 2003 Dec 15.
\bibitem[25]{bib-gaudry-gurel}\hypertarget{bib-gaudry-gurel}{}Gaudry, Pierrick, and Nicolas Gürel. \textit{An extension of Kedlaya's point-counting algorithm to superelliptic curves}. Advances in Cryptology - ASIACRYPT 2001, Springer, Berlin, Heidelberg, 2001.
\bibitem[26]{bib-gerritzen-van-der-put}\hypertarget{bib-gerritzen-van-der-put}{}Gerritzen, L. and Van der Put, M., 2006. \textit{Schottky groups and Mumford curves} (Vol. 817). Springer.
\bibitem[27]{bib-goncalves}\hypertarget{bib-goncalves}{}Gonçalves, Cécile. \textit{A point counting algorithm for cyclic covers of the projective line}. Contemporary mathematics 637 (2015): 145.
\bibitem[28]{bib-goncharov-mixed}\hypertarget{bib-goncharov-mixed}{}Goncharov, Alexander. \textit{Mixed elliptic motives}. London Mathematical Society Lecture Note Series (1998): 147-222.
\bibitem[29]{bib-gl}\hypertarget{bib-gl}{}Goncharov, Alexander B., and Andrey M. Levin. \textit{Zagier's conjecture on L (E, 2)}. Inventiones mathematicae 132, no. 2 (1998): 393-432.
\bibitem[30]{bib-harrison-hyperelliptic}\hypertarget{bib-harrison-hyperelliptic}{}Harrison, Michael C. \textit{An extension of Kedlaya's algorithm for hyperelliptic curves}. Journal of Symbolic Computation 47.1 (2012): 89-101.
\bibitem[31]{bib-hartshorne}\hypertarget{bib-hartshorne}{}Hartshorne, Robin. \textit{Algebraic geometry}. Vol. 52. Springer Science \& Business Media, 2013.
\bibitem[32]{bib-harvey-average}\hypertarget{bib-harvey-average}{}Harvey, David. \textit{Counting points on hyperelliptic curves in average polynomial time}. Annals of Mathematics 179, no. 2 (2014): 783-803.
\bibitem[33]{bib-harvey-sqrtp}\hypertarget{bib-harvey-sqrtp}{}Harvey, David. \textit{Kedlaya's Algorithm in Larger Characteristic}. IMRN: International Mathematics Research Notices 2007 (2007).
\bibitem[34]{bib-harvey-sutherland}\hypertarget{bib-harvey-sutherland}{}Harvey, David, and Andrew V. Sutherland. \textit{Computing Hasse–Witt matrices of hyperelliptic curves in average polynomial time}. LMS Journal of Computation and Mathematics 17, no. A (2014): 257-273.
\bibitem[35]{bib-harvey-sutherland-ii}\hypertarget{bib-harvey-sutherland-ii}{}Harvey, David, and Andrew V. Sutherland. \textit{Computing Hasse-Witt matrices of hyperelliptic curves in average polynomial time II}. Frobenius distributions: Lang–Trotter and Sato–Tate conjectures, Contemporary Mathematics 663 (2016): 127-148.
\bibitem[36]{bib-hida-geometric}\hypertarget{bib-hida-geometric}{}Hida, Haruzo. \textit{Geometric modular forms and elliptic curves}. World Scientific, 2012.
\bibitem[37]{bib-katz-serre-tate}\hypertarget{bib-katz-serre-tate}{}Katz, Nicholas. \textit{Serre-Tate local moduli}. In Surfaces algébriques, pp. 138-202. Springer, Berlin, Heidelberg, 1981.
\bibitem[38]{bib-kedlaya-counting}\hypertarget{bib-kedlaya-counting}{}Kedlaya, Kiran S. \textit{Counting points on hyperelliptic curves using Monsky-Washnitzer cohomology}, J. Ramanujan Math. Soc. 16 (2001), no. 4, 323-338; errata, ibid. 18 (2003), 417--418.
\bibitem[39]{bib-lang-algebra}\hypertarget{bib-lang-algebra}{}Lang, Serge,  \textit{Algebra}, Graduate Texts in Mathematics 1.211 (2002): ALL-ALL.
\bibitem[40]{bib-lee-smooth}\hypertarget{bib-lee-smooth}{}Lee, John M. \textit{Smooth manifolds}. Springer, New York, NY, 2003. 9780387954486.
\bibitem[41]{bib-le-gall}\hypertarget{bib-le-gall}{}Le Gall, François. \textit{Faster algorithms for rectangular matrix multiplication}. In Foundations of Computer Science (FOCS), 2012 IEEE 53rd Annual Symposium on, pp. 514-523. IEEE, 2012.
\bibitem[42]{bib-mazur-stein-tate}\hypertarget{bib-mazur-stein-tate}{}Mazur, Barry, William Stein, and John Tate. \textit{Computation of p-adic heights and log convergence.} Doc. Math (2006): 577-614.
\bibitem[43]{bib-milne-etale}\hypertarget{bib-milne-etale}{}Milne, James S. \textit{Etale cohomology} (PMS-33). Vol. 33. Princeton university press, 2016.
\bibitem[44]{bib-minzlaff}\hypertarget{bib-minzlaff}{}Minzlaff, Moritz. \textit{Computing zeta functions of superelliptic curves in larger characteristic}. Mathematics in Computer Science 3.2 (2010): 209-224.
\bibitem[45]{bib-mumford-abvar}\hypertarget{bib-mumford-abvar}{}Mumford, David. \textit{Abelian varieties}. Vol. 5. Oxford University Press, USA, 1974.
\bibitem[46]{bib-narkiewicz}\hypertarget{bib-narkiewicz}{}Narkiewicz, Wladyslaw  \textit{Elementary and Analytic Theory of Algebraic Numbers}. Springer, 2004.
\bibitem[47]{bib-polishchuck}\hypertarget{bib-polishchuck}{}Polishchuk, Alexander. \textit{Abelian varieties, theta functions and the Fourier transform}. Vol. 153. Cambridge University Press, 2003.
\bibitem[48]{bib-rolshausen}\hypertarget{bib-rolshausen}{}Rolshausen, Klaus, and Norbert Schappacher.  \textit{On the second K-group of an elliptic curve.}  Journal für die reine und angewandte Mathematik 495 (1998): 61-77.
\bibitem[49]{bib-sage}\hypertarget{bib-sage}{}\textit{SageMath, the Sage Mathematics Software System (Version 8.1.0)}, The Sage Developers, 2017, \url{http://www.sagemath.org}.
\bibitem[50]{bib-serre-local-alg}\hypertarget{bib-serre-local-alg}{}Serre, Jean-Pierre. \textit{Local algebra}. Springer Science \& Business Media, 2000.
\bibitem[51]{bib-serre-mordell-weil}\hypertarget{bib-serre-mordell-weil}{}Serre, Jean-Pierre, Martin Brown, and Michel Waldschmidt. \textit{Lectures on the Mordell-Weil theorem}. Vol. 2. Braunschweig: Vieweg, 1990.
\bibitem[52]{bib-shafarevich-remizov}\hypertarget{bib-shafarevich-remizov}{}Shafarevich, Igor R., and Alexey O. Remizov. \textit{Linear algebra and geometry}. Springer Science \& Business Media, 2012.
\bibitem[53]{bib-silverman}\hypertarget{bib-silverman}{}Silverman, Joseph H. \textit{The arithmetic of elliptic curves}. Vol. 106. Springer Science \& Business Media, 2009.
\bibitem[54]{bib-silverman-advanced}\hypertarget{bib-silverman-advanced}{}Silverman, Joseph H. \textit{Advanced topics in the arithmetic of elliptic curves}. Vol. 151. Springer Science \& Business Media, 2013.
\bibitem[55]{bib-tamme}\hypertarget{bib-tamme}{}Tamme, Günter. \textit{Introduction to étale cohomology}. Springer Science \& Business Media, 2012.
\bibitem[56]{bib-tuitman-map-to-p1-1}\hypertarget{bib-tuitman-map-to-p1-1}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\)}. Mathematics of Computation 85.298 (2016): 961-981.
\bibitem[57]{bib-tuitman-map-to-p1-2}\hypertarget{bib-tuitman-map-to-p1-2}{}Tuitman, Jan. \textit{Counting points on curves using a map to \(\PP^1\), II}. Finite Fields and Their Applications 45 (2017): 301-322.
\bibitem[58]{bib-vandergeer-moonen}\hypertarget{bib-vandergeer-moonen}{}van der Geer, G., Moonen, B. \textit{Abelian Varieties}, from \url{https://www.math.ru.nl/\~bmoonen/research.html\#bookabvar}.
\bibitem[59]{bib-waterhouse}\hypertarget{bib-waterhouse}{}Waterhouse, William C.  \textit{Profinite groups are Galois groups}. Proceedings of the American Mathematical Society 42.2 (1974): 639-640.
\bibitem[60]{bib-weng-nakamura}\hypertarget{bib-weng-nakamura}{}Weng, L., and Nakamura, I. \textit{Arithmetic geometry and number theory}, World Scientific, 2006.
\bibitem[61]{bib-zag-ram}\hypertarget{bib-zag-ram}{}Zagier, Don.  \textit{The Bloch-Wigner-Ramakrishnan polylogarithm function.} Mathematische Annalen 286, no. 1 (1990): 613-624.
\bibitem[62]{bib-pug}\hypertarget{bib-pug}{}\textit{Pug Template Engine} see \href{http://pug-lang.com/}{pug-lang.com}.
\end{thebibliography}
\end{document}