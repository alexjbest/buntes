...
\hypertarget{p-324}{}%
\(A\) an \hyperref[def-buntes-abvar]{abelian variety}, \(\lambda \colon A \to A^\vee\) is a \hyperref[def-polarization]{polarization} with \((\deg (\lambda), p) = 1\) then \(A\) is  isogenous to a \hyperref[def-princ-pol-av]{principally polarized abelian variety}.%
\end{corollary}
...
\typeout{************************************************}
%
\begin{sectionptx}{Variations of Hodge Structures (Sachi)}{}{Variations of Hodge Structures (Sachi)}{}{}\label{sec-buntes-vhs}
%
%
\typeout{************************************************}
...
\begin{definition}{Real forms.}{def-real-forms}%
\hypertarget{p-1201}{}%
